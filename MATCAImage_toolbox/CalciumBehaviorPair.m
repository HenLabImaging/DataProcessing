function CalciumBehaviorPair(fs_Ca,fs_video,time1,time2,var1,var2,var3,var4)
ui.fh = figure('Visible','on','Position',[10,10,1000,600],'Units','normalized');
set(gcf,'Color','[1 1 1]')
ui.data = uicontrol('Parent', ui.fh ,'Style','pushbutton','String','LOAD','Position',[50,25,100,30],'Callback',@load,'FontSize',16,'Units','normalized');
...
ui.text_slidermin = uicontrol('Style',' edit','String','0','Position',[180,10,50,20],'backgroundc',get(ui.fh,'color'),'Units','normalized','FontSize',12);
ui.text_slidermax = uicontrol('Style',' edit','String',' ','Position',[720,10,50,20],'backgroundc',get(ui.fh,'color'),'Units','normalized','FontSize',12);
...
%         set(ui.r1,'str',num2str(r1))
       ...
       legend('sd','mean','R1 corr','R2 corr')
