...
uicontrol('Style','Text','String','Available Data','Position',[410,520,200,400],'backgroundc',get(Place.tool,'color'),'FontSize',16,'Units','normalized');
...
Place.data_list2 = uicontrol('Style','listbox','String',' ','Position',[80,500,200,400],'FontSize',12,'Units','normalized');
 ...
 Place.sampling  = uicontrol('Style',' edit','String','Sampling Rate','Position',[300,850,100,30],'Units','normalized','FontSize',12);
 Place.start_time  = uicontrol('Style',' edit','String','Start time','Position',[300,800,100,30],'Units','normalized','FontSize',12);
 Place.end_time = uicontrol('Style',' edit','String','End time ','Position',[300,750,100,30],'Units','normalized','FontSize',12);
 Place.cell1  = uicontrol('Style',' edit','String','First Cell# ','Position',[300,700,100,30],'Units','normalized','FontSize',12);
 Place.cellend  = uicontrol('Style',' edit','String','Last Cell# ','Position',[300 650,100,30],'Units','normalized','FontSize',12);
 Place.dataname  = uicontrol('Style',' edit','String','Name Data','Position',[300 600,100,30],'Units','normalized','FontSize',12);

 
 
Place.data_list = uicontrol('Style','listbox','String',' ','Position',[450,600,140,300],'FontSize',12,'Units','normalized');
...
%         clear guidat
        ...
        data=DataRead(fs,st_time,end_time,cell1,cellend);
